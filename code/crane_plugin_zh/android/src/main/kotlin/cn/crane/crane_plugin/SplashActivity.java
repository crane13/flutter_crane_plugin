...
import cn.crane.crane_plugin.utils.UIUtils;
...
public class SplashActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTTAdNative = TTUtils.get().createAdNative(this);
        getExtraInfo();
...
//        }
    ...
    private void loadSplashAd() {
        ...
        if (mIsExpress) {
            ...
            adSlot = new AdSlot.Builder()
                    .setCodeId(Const.INSTANCE.getTT_SPLASH())
    ...
    protected void goToMainActivity() {
        Intent intent = new Intent(SplashActivity.this, CraneActivity.class);
